 ...
 *
 */
public abstract class AvroRecordBaseCandidateWrapper
implements BaseCandidate
    {
    /**
     * Public constructoor.
     * Note - this will ignore the objectid parameter and returns the objectid from the record. 
     * @param record The {@link GenericData.Record} to wrap.
     * @param objectid This parameter is not used.
     * 
     */
    public AvroRecordBaseCandidateWrapper(final GenericData.Record record, final CharSequence objectid)
        {
        this.record = record;
        }
